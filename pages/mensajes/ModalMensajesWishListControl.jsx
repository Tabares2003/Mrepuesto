...
function ModalMensajesWishListControl(props) {
    ...
    return shown ? (
        <div
            ...
            <div
                className="modal-wish-list-control redondearventamensajes "
                onClick={(e) => {
                ...
                <div>
                    <Row>
                        ...
                        <Col xl={1} lg={1} md={1} sm={1}>
                            <button
                                type="button"
                                className="cerrarmodal ml-10 sinborder colorbase"
                                data-dismiss="modal"
                                onClick={() => close(false)}>
                                {" "}
                                X{" "}
                ...
                <div className="mt-20 textomensajeslistadeseos">{mensaje}</div>
                <div
                    className="mt-20 textomensajeslistadeseossoynuevo"
                    onClick={() => soynuevo()}>
                    Crea tu cuenta
                </div>
                <div
                    className="mt-20 textomensajeslistadeseostengocuenta"
                    onClick={() => tengocuenta()}>
                    Ingresa a tu cuenta
                </div>
            </div>
