                                    ...
                                    <Grid container>
                                        <Grid item xs={12} md={7} sx={{ width: isMdDown ? '100%' : '90%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
                                            ...
                                            <Grid item xs={12} md={12} sx={{ width: isMdDown ? '100%' : '90%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'flex-end' }}>
                                                <p style={{ fontSize: '18px', fontWeight: '500', color: '#2D2E83' }}>Elige de uno a cinco la calificación del producto que recibiste, siendo uno lo más bajo y cinco lo más alto:</p>
                                                ...
                                                <div style={{ width: '100%' }}>
                                                    <p style={{ fontSize: '18px', fontWeight: '500', color: '#2D2E83', marginTop: '3rem', marginBottom: '3rem' }}>Si deseas deja un comentario sobre tu producto:</p>
